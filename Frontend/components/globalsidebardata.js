...
export const sidebarMenuData = {
  ...
  client_user: [
    ...
    },
    {
      label: "AI Analytics",
      icon: "fas fa-brain",
      page: "amc-analytics.html",
      badge: "ai",
      description: "AI-powered analytics with explosive visualizations"
    },
    { 
      label: "Profile", 
      icon: "fas fa-user-circle", 
  ...
  client_admin: [
    ...
    },
    {
      ...
      page: "amc-analytics.html",
      badge: "ai",
      description: "AI-powered company analytics with explosive insights"
    },
    { 
      label: "Profile", 
      icon: "fas fa-user-circle", 
